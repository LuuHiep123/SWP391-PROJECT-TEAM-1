 ...
 * @author HoangNQ
 */
public class SearchKeySubjectTeacherController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null && session.getAttribute("USER") != null) {
                String searchSubjectTeacher = request.getParameter("searchSubjectTeacher");
                UserDTO user = (UserDTO) session.getAttribute("USER");
                
                String email = user.getEmail();
                TeacherScheduleDAO dao = new TeacherScheduleDAO();
                List<TeacherScheduleDTO> ListExam = new ArrayList<>();
                ListExam = dao.SearchKeySubjectTeacher(email, searchSubjectTeacher);
                if (!ListExam.isEmpty()) {
                    url = SUCCESS;
